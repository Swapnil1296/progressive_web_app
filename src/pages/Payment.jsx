...
const Payment = () => {
  ...
  const handleOnSubmit = () => {
    window.alert("Payment is Successfull !");
    navigate("/");
        ...
        <div class="grid lg:grid-cols-3 gap-6 max-lg:gap-8 mt-16">
          <div class="lg:col-span-2">
            ...
            <form class="mt-8">
              ...
              <div class="flex flex-wrap gap-4 mt-8">
                <button
                  type="button"
                  class="px-7 py-3.5 text-sm tracking-wide bg-white hover:bg-gray-50 text-gray-800 rounded-md"
                >
                  Pay later
                </button>
                <button
                  ...
                  type="button"
                  class="px-7 py-3.5 text-sm tracking-wide bg-blue-600 text-white rounded-md hover:bg-blue-700"
                >
                  Submit
                </button>
              </div>
          ...
          <div class="bg-white p-6 rounded-md max-lg:-order-1">
            ...
            <ul class="text-gray-800 mt-6 space-y-3">
              ...
              <li class="flex flex-wrap gap-4 text-sm">
                Discount (20%) <span class="ml-auto font-bold">₹4.00</span>
              </li>
              <li class="flex flex-wrap gap-4 text-sm">
              ...
              <li class="flex flex-wrap gap-4 text-base font-bold">
                Total{" "}
                <span class="ml-auto">
                  ₹ {(getTotalPrice(cart) + 8).toFixed(2)}
                </span>
              </li>
            </ul>
          </div>
